...
describe('Transform Option', () => {
  test('No Default', () => {
    ...
    const transformer_option = new utils.TransformerOption(name, description, type);
  ...
  test('Default', () => {
    ...
    const transformer_option = new utils.TransformerOption(name, description, type, default_value);
...
describe('Transformer', () => {
  ...
  test('No Config / Options', () => {
    ...
    const transformer = new utils.Transformer(name, undefined, opts);
    expect(transformer.name).toEqual(name);
    expect(transformer.config).toEqual({});
    expect(transformer.transform()).toBeUndefined();
  });
  test('Config / No Options', () => {
    ...
    const config = [
      new utils.TransformerOption(config_name, config_description, config_type),
      new utils.TransformerOption(config_unset_name, config_unset_description, config_type)
    ];
